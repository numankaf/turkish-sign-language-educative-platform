...
const AppTopbar = () => {
    ...
    const toggleDarkMode = (checked: boolean) => {
        setDarkMode(checked);
        changeTheme(isDarkMode ? "lara-dark-teal" : "lara-light-teal", isDarkMode ? "lara-light-teal" : "lara-dark-teal", "theme-link", () => {});
        localStorage.setItem("theme", isDarkMode ? "lara-light-teal" : "lara-dark-teal");
    };
                                ...
                                <div>
                                    <div>
                                        <button
                                            ...
                                            type="button"
                                        >
                                            <img className="w-[35px] h-[35px] rounded-full " loading="lazy" src={"/images/empty-profile.jpg"} />
                                    ...
                                    {open && (
                                        <div
                                            className="fadein animation-duration-150 absolute right-0 z-10 top-12 w-max origin-top-right rounded-md surface-overlay shadow-lg min-w-[12rem]"
                                        ...
                                        >
                                            <div className="py-1 m-1 divide-y divide-gray-100 ">
                                                ...
                                                <div className="flex flex-row gap-1 items-center hover:surface-hover rounded-md px-1">
                                                    <MdLogout />
                                                    <button type="submit" onClick={logout} className=" block px-1 py-2 ">
                                                        Sign out
                                                    </button>
                                                </div>
                                            </div>
